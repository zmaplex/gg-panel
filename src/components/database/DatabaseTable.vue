<template>
  ...
  <div class="flex justify-between">
    ...
    <div>
      <q-btn color="white" flat icon="sync" text-color="dark" @click="Public.loadingTableData()"></q-btn>
    </div>
  </div>
...
const Private = {
  _loadingTableData: async function () {
